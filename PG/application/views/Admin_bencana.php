...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Tabel Bencana</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="panel-heading">
                            <button class="btn btn-primary btn-round" data-toggle="modal" data-target="#myModalTambah" onclick="clearData()"> Tambah Data Bencana</button>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <?php $start = 0; foreach ($crud_berita as $get_data)
                                            {
                                               ?>
                                    
                                        <tr>
                                        <td><?php echo $get_data->id_bencana ?></td>
                                        <td><?php echo $get_data->judul_bencana ?></td>
									    <td><?php echo $get_data->tanggal_posting ?></td>
                                        <td><?php echo $get_data->total_donasi ?></td>
                                        <td class="td-actions text-right">
                                                    <button type="button" rel="tooltip" title="Read More" class="btn btn-info btn-simple btn-xs" onclick="ViewData(<?php echo $get_data->id_bencana ?>)">
                                                        <i class="material-icons">View2</i>
                                                    </button>
													<button type="button" rel="tooltip" title="Edit Task" class="btn btn-primary btn-simple btn-xs" onclick="EditData(<?php echo $get_data->id_bencana ?>)">
														<i class="material-icons">edit</i>
													</button>
													<button type="button" rel="tooltip" title="Remove" class="btn btn-danger btn-simple btn-xs" data-toggle="modal" data-target="#myModalHapus" onclick="SaveId(<?php echo $get_data->id_bencana ?>)">
        ...
        <form action="<?php echo site_url('insert_bencana');?>" method="post" enctype="multipart/form-data">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="form-group label-floating">
						<label class="control-label">Judul Bencana</label>
						<input type="text" id="judul_bencana" name="judul_bencana" class="form-control" required>
					</div>
					<div class="form-group label-floating">
                    <label class="control-label">Deskripsi Bencana</label>
                    <textarea name="deskripsi_bencana" class="form-control" rows="5" ></textarea>
					</div>
					<!-- <div class="form-group label-floating">
						<label class="control-label">Tanggal Posting</label>
						<input type="text" id="tanggal_posting" name="nama" class="form-control" required>
					</div> -->
                    <div class="input-group">
                        <input type="file" accept="image/gif,image/jpeg,image/png" class="btn btn-primary" name="tumnel" id="tumnel" required/>
                    </div>
				</div>
				<div class="modal-footer">
    ...
    {
        $.ajax({
            url : "<?php echo site_url('Penggalangdanaweb_controller/ajax_edit')?>/" + id_pengguna ,
            type: "GET",
            dataType: "JSON",
    ...
    function SaveId(id_bencana)
    {
        $.ajax({
            type: "GET",
            url: "<?php echo site_url('getidBencana'); ?>",
    ...
    function AddData(id_bencana)
    {
        $.ajax({
            url : "<?php echo site_url('Bencana_controller/ajax_view')?>/" + id_bencana,
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {
                $('[name="id_bencana"]').val(data.id_bencana);
                $('[name="judul_bencana"]').val(data.judul_bencana);
                $('[name="deskripsi_bencana"]').val(data.deskripsi_bencana);
                $('[name="tanggal_posting"]').val(data.tanggal_posting);
                $('[name="tumnel"]').attr('src',"<?php echo base_url();?>images/Bencana"+data.tumnel);
                // $('[name="total_donasi"]').val(data.total_donasi);
                $('[name="unik_donasi"]').val(data.unik_donasi);
