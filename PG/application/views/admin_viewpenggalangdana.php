        ...
        <div id="page-wrapper">
            <div class="row">
	                    <div class="col-md-8">
	                        <div class="card">
                            <div class="col-lg-12">
                    <h1 class="page-header">Tabel penggalang dana</h1>
                    </div>
                                        ...
                                        <div class="row">
											<div class="col-md-12">
												<div class="form-group label-floating">
													...
													<textarea  rows="5" value="#" class="form-control" disabled> 
                                                    </textarea>
												</div>
	                                        </div>
						...
						<div class="col-md-4">
    						<div class="card card-profile">
    							...
    							<div class="content">
    								<h6 class="category text-gray">Penggalang Dana</h6>
    								<h4 class="card-title"></h4>
									<h4 class="card-title"></h4>
									<?php
									('<button href="#pablo" class="btn btn-primary btn-round">Edit Data</button>');
									?>
									<button class="btn btn-danger btn-round" data-toggle="modal" data-target="#myModal" onclick="#">Hapus</button>
									<?php
