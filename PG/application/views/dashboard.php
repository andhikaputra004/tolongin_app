...
<head>
    ...
    <!-- Morris Charts CSS -->
    <link href="<?php echo base_url(); ?>aset/vendor/morrisjs/morris.css" rel="stylesheet">
...
<body>
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="#"><i class="fa fa-user fa-fw"><?php echo $this->session->userdata("nama") ?></i></a>
                        </li>
    ...
    <script src="<?php echo base_url(); ?>aset/vendor/raphael/raphael.min.js"></script>
    <script src="<?php echo base_url(); ?>aset/vendor/morrisjs/morris.min.js"></script>
    <script src="<?php echo base_url(); ?>aset/data/morris-data.js"></script>
